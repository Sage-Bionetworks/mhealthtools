...
```{r, warning=FALSE, error=FALSE, prompt=FALSE}
accel_features <- accelerometer_features(accelerometer_data, time_range = c(2,5))
...
You can also specify the threshold for the intertap distance in the x-axis using the `depressThr` parameter of the get_tapping_features function
