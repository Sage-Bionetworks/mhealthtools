...
```
*To use the default feature extraction pipelines you need to get the data in the proper format -- as that of the sample data. You can also define your own features or feed in a custom model to extract features in `mhealthtools`!*
