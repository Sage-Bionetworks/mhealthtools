####### MAIN
#' extracts hr for each color band from avg pixel value per frame of video (processed hr input)
#'
#'
#' @params a dataframe(dat) containing timestamp, red, green and blue columns
...
get_hr <- function(dat, windowLen = 10, freqRange = c(1,25), bpforder = 128){
